function [g_common, dU_common, MFPT_common] = prepare_and_plot_A_MFPT_vs_Barrier(gB, Barrier, gM, MFPT, figure_folder_name, doLogMFPT, plotOpts)
...
%   MFPT_common        : matched MFPT or ln(MFPT)
    ...
    plot_A_MFPTvsdeltaU(dU_common, MFPT_common, figure_folder_name, plotOpts);
end
