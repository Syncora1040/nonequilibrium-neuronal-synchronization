function plot_3D_landscape_with_paths_R(xvec, yvec, U, path_f, path_b, param, figure_folder_name, fig_name, varargin)
...
addParameter(p,'MarkerSize',200,@isnumeric);
...
addParameter(p,'DirectionMarkerSize',280,@isnumeric);
...
scatter3(pf_start(1), pf_start(2), zf_start, ...
    ...
    'LineWidth',1.2);
% text(pf_start(1), pf_start(2), zf_start + 0.2*zrange, ...
%     'AS', ...
%     'FontSize',35, ...
%     'FontWeight','bold', ...
%     'Color',colAsync, ...
...
scatter3(pf_end(1), pf_end(2), zf_end, ...
    ...
    'MarkerEdgeColor','none', ...
    'LineWidth',1.2);
% text(pf_end(1)-0.3, pf_end(2)+0.05, zf_end + 0.5*zrange, ...
%     'SS', ...
%     'FontSize',35, ...
%     'FontWeight','bold', ...
%     'Color',colSync, ...
...
scatter3(pb_start(1), pb_start(2), zb_start, ...
    ...
    'MarkerEdgeColor','none', ...
    'LineWidth',1.2);
% text(pb_start(1), pb_start(2), zb_start + 0.06*zrange, ...
%     'Syn state', ...
%     'FontSize',30, ...
%     'FontWeight','bold', ...
%     'Color',[1 1 0], ...
...
% 坐标轴与风格
% ========================================================
xlabel('R_E','FontSize',50,'FontWeight','bold');
ylabel('R_I','FontSize',50,'FontWeight','bold');
